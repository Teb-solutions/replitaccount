 ...
 * Deployment-ready with external database connection
 */
...
// Database configuration for external connection
const pool = new Pool({
...
// Intercompany workflow endpoints
    ...
    window.onload = function() {
      const spec = {
        ...
        info: {
          ...
          version: '1.0.0',
          description: 'Production-ready multi-tenant accounting platform'
        },
          ...
          '/api/ar-ap-summary': {
            get: {
              ...
              parameters: [{ 
                ...
                required: true,
                schema: { type: 'integer' },
                description: 'Company ID for AR/AP summary'
              }],
              responses: { '200': { description: 'Complete AR/AP summary with totals and outstanding amounts' } }
            }
          },
